...
# Let's declare block size as a function of frames
block_sizes = [100,200,300,400, 500,600,700,800,900, 1000, 2000, 5000,
            10000, 20000, 25000]
fig, ax = plt.subplots(1,2)
for block_size in block_sizes:
    n_blocks = int(traj.n_frames / block_size)
    all_ka = []
...
corr_length = 25000
dt = 10
time_origins = np.arange(0, traj.n_frames - corr_length, step=dt)
all_corrs = []
...
# Look at areas
fig, ax = plt.subplots(1,1)
ax.plot(np.arange(0, len(areas)), areas._value)
ax.set_xlabel("Frame")
ax.set_ylabel("Area")
ax.grid()
fig.tight_layout()
