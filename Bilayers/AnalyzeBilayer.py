...
apt_avg, apt_std, apt_list = bilayer_analysis_functions.calc_APT(apl_list, angle_list, n_tails_per_lipid)
...
Hpp_ave, Hpp_std, Hpp_list = bilayer_analysis_functions.calc_bilayer_height(headgroup_distance_dict)
print('Calculating component offsets...')
offset_dict = bilayer_analysis_functions.calc_offsets(headgroup_distance_dict)
